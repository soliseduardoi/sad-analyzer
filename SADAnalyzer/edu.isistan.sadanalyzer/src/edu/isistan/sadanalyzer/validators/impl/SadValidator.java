...
public class SadValidator extends SadAnalyzerWizardValidator{
	
	private static final String FILE_IMPORT_SAD_MASK = "sad";

	@Override
	public String getMessages() {
		return Messages.SadAnalyzerWizard_ErrorMaskFile + " ." + FILE_IMPORT_SAD_MASK;
	}

	@Override
	public String getMask() {
		return FILE_IMPORT_SAD_MASK;
	}
