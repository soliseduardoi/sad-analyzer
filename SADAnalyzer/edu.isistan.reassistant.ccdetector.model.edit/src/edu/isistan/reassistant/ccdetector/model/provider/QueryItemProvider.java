...
/**
 * This is the item provider adapter for a {@link edu.isistan.reassistant.ccdetector.model.Query} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CCDetectorModelPackage.Literals.QUERY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Query_Content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Query_Content_feature", "_UI_Query_type"),
				 CCDetectorModelPackage.Literals.QUERY__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIncludePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Query_Include_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Query_Include_feature", "_UI_Query_type"),
				 CCDetectorModelPackage.Literals.QUERY__INCLUDE,
				 true,
				 false,
				 false,
