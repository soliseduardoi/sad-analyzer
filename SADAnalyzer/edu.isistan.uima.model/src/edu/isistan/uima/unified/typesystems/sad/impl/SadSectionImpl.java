 ...
 * @generated
 */
public class SadSectionImpl extends IdentifiableAnnotationImpl implements SadSection {
	/**
	...
	protected EClass eStaticClass() {
		return SadPackage.Literals.SAD_SECTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SadPackage.SAD_SECTION__NAME, oldName, name));
	}
	...
	public void setText(String newText) {
		...
		text = newText;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SadPackage.SAD_SECTION__TEXT, oldText, text));
	}
