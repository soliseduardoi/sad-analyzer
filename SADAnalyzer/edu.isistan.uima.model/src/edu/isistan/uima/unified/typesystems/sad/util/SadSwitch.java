	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SadPackage.SAD: {
				...
				if (result == null) result = caseIdentifiableAnnotation(sad);
				if (result == null) result = caseAnnotation(sad);
				if (result == null) result = caseAnnotationBase(sad);
				if (result == null) result = caseTOP(sad);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SadPackage.SAD_SECTION: {
				SadSection sadSection = (SadSection)theEObject;
				T result = caseSadSection(sadSection);
				if (result == null) result = caseIdentifiableAnnotation(sadSection);
				if (result == null) result = caseAnnotation(sadSection);
				if (result == null) result = caseAnnotationBase(sadSection);
				if (result == null) result = caseTOP(sadSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
