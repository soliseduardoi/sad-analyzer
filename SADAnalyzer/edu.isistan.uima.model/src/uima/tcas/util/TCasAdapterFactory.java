 ...
 * @generated
 */
public class TCasAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected TCasSwitch<Adapter> modelSwitch =
		new TCasSwitch<Adapter>() {
			@Override
			public Adapter caseAnnotation(Annotation object) {
				return createAnnotationAdapter();
			}
			@Override
			public Adapter caseDocumentAnnotation(DocumentAnnotation object) {
				return createDocumentAnnotationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link uima.tcas.DocumentAnnotation <em>Document Annotation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDocumentAnnotationAdapter() {
		return null;
	}
