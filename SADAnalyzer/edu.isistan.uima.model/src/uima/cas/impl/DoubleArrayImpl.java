 ...
 * <ul>
 *   <li>{@link uima.cas.impl.DoubleArrayImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DoubleArrayImpl extends ArrayBaseImpl implements DoubleArray {
	/**
	...
	protected EClass eStaticClass() {
		return CasPackage.Literals.DOUBLE_ARRAY;
	}
	...
	public EList<Double> getElements() {
		if (elements == null) {
			elements = new EDataTypeUniqueEList<Double>(Double.class, this, CasPackage.DOUBLE_ARRAY__ELEMENTS);
		}
		return elements;
	}
