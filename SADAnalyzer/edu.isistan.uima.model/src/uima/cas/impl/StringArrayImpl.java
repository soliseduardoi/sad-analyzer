 ...
 * <ul>
 *   <li>{@link uima.cas.impl.StringArrayImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StringArrayImpl extends ArrayBaseImpl implements StringArray {
	/**
	...
	protected EClass eStaticClass() {
		return CasPackage.Literals.STRING_ARRAY;
	}
	...
	public EList<String> getElements() {
		if (elements == null) {
			elements = new EDataTypeUniqueEList<String>(String.class, this, CasPackage.STRING_ARRAY__ELEMENTS);
		}
		return elements;
	}
