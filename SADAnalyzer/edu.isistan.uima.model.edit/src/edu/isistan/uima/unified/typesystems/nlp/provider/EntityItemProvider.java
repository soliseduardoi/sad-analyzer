...
/**
 * This is the item provider adapter for a {@link edu.isistan.uima.unified.typesystems.nlp.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NLPPackage.Literals.ENTITY__KIND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Entity_type") + " " + entity.getBegin();
	}
