...
/**
 * This is the item provider adapter for a {@link edu.isistan.uima.unified.typesystems.sad.Sad} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SadItemProvider
	 ...
	 * @generated
	 */
	public SadItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sad_sections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sad_sections_feature", "_UI_Sad_type"),
				 SadPackage.Literals.SAD__SECTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTemplatePathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sad_templatePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sad_templatePath_feature", "_UI_Sad_type"),
				 SadPackage.Literals.SAD__TEMPLATE_PATH,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Sad"));
	}
