...
/**
 * This is the item provider adapter for a {@link edu.isistan.uima.unified.typesystems.srs.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SRSPackage.Literals.PROJECT__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SRSPackage.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_content_feature", "_UI_Project_type"),
				 SRSPackage.Literals.PROJECT__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_kind_feature", "_UI_Project_type"),
				 SRSPackage.Literals.PROJECT__KIND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_URI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_URI_feature", "_UI_Project_type"),
				 SRSPackage.Literals.PROJECT__URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Project.class)) {
			case SRSPackage.PROJECT__ID:
			case SRSPackage.PROJECT__NAME:
			case SRSPackage.PROJECT__CONTENT:
			case SRSPackage.PROJECT__KIND:
			case SRSPackage.PROJECT__URI:
