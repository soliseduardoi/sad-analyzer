...
import uima.cas.provider.AnnotationBaseItemProvider;

import uima.tcas.Annotation;
import uima.tcas.TCasPackage;

/**
 * This is the item provider adapter for a {@link uima.tcas.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_begin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_begin_feature", "_UI_Annotation_type"),
				 TCasPackage.Literals.ANNOTATION__BEGIN,
				 true,
				 false,
				 false,
	...
	protected void addEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_end_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_end_feature", "_UI_Annotation_type"),
				 TCasPackage.Literals.ANNOTATION__END,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Annotation_type") + " " + annotation.getBegin();
	}
